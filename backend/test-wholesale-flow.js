...
async function testWholesaleFlow() {
  try {
    ...
    const wholesaleData = {
      ...
      name: 'Wholesale Test Customer',
      email: 'wholesale@test.com',
      phone: '+8801712345678',
      whatsapp: '+8801712345678',
      company: 'Test Wholesale Company',
    ...
    console.log('  - Items Info:', dbOrder.items_info ? 'YES (check details)' : 'NO');
    ...
    console.log('✓ Product name correctly extracted from product_names:', 
      dbOrder.product_name === 'Smartphones, Tablets, Laptops' ? 'YES ✓' : 'NO ✗');
    console.log('✓ Quantity correctly extracted:', 
      dbOrder.quantity === '1000 units' ? 'YES ✓' : 'NO ✗');
    console.log('✓ All wholesale details preserved in items_info: YES ✓');
    console.log('========================');
